...
import com.rtb.rtbdemand.sdk.ErrorCode
...
class NativeAdLoader(private val mediationNativeAdConfiguration: MediationNativeAdConfiguration,
    ...
    fun loadAd() {
        ...
        val request = RtbAdapter.createAdRequest(mediationNativeAdConfiguration)
    ...
    override fun onAdFailedToLoad(p0: LoadAdError) {
        ...
        mediationAdLoadCallback.onFailure(RTBDemandError.createSampleSdkError(ErrorCode.BAD_REQUEST))
    }
